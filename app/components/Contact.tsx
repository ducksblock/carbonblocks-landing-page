...
const Contact = () => {
  return (
    <>
      ...
      <Link href="https://www.linkedin.com/company/carbonblocks" target="https://www.linkedin.com/company/carbonblocks">
        <div
          className="
            scroll-smooth
            text-[40px]
      ...
      <Link href="https://twitter.com/0xcarbonblocks" target="https://twitter.com/0xcarbonblocks">
        <div
          className="
            scroll-smooth
            text-[40px]
